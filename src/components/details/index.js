    ...
    <div className="details-container">
      <div className="ui container">
        ...
        <h3 className="ui header details-item">
          <img src={question} alt="question" className="ui image" />
          Free drinks & food +... (Verrassing!)
        </h3>
        <h3 className="ui header details-item">
          <img src={calendar} alt="calendar" className="ui image" />
          30 juli 2019, 18u.
        </h3>
        <h3 className="ui header details-item">
          <img src={mapLocation} alt="mapLocation" className="ui image" />
          Wommelgem
        </h3>
      </div>
    </div> 
